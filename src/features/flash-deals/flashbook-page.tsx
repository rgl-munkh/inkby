...
import { NewFlashSheet } from "@/features/flash-deals/new-flash-sheet";
import type { FlashDealSheetDeal } from "@/features/flash-deals/types";
...
export function FlashbookPage() {
  ...
  const [dealPendingDelete, setDealPendingDelete] =
    useState<FlashDealSheetDeal | null>(null);
  ...
  return (
    <div className="max-w-xl mx-auto flex flex-col min-h-full pb-[calc(1.5rem+env(safe-area-inset-bottom))] bg-background">
      <header className="flex items-center justify-between px-4 pt-4 pb-3">
        <h1 className="text-xl font-bold text-foreground">Flashbook</h1>
        <Button
          type="button"
          size="icon"
          onClick={() => {
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center px-8 py-16 gap-4 text-center">
          ...
          <p className="text-sm font-semibold text-foreground">No flash yet</p>
              ...
              <div className="relative aspect-square w-full bg-muted">
                ...
                <div className="absolute top-2 right-2 flex gap-1">
                  <button
                    ...
                    className="w-8 h-8 rounded-full flex items-center justify-center border border-border transition-opacity hover:opacity-90 shadow-sm"
