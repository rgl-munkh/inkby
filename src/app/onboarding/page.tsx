...
export default function OnboardingPage() {
  ...
  function goToStep2() {
    ...
    if (slug.length < 2) { setError("Username must be at least 2 characters"); return; }
    setError("");
    setStep(2);
  }
    ...
    <main className="min-h-screen flex bg-inkby-canvas">
      ...
      <div className="hidden lg:grid lg:w-1/2 grid-cols-2 grid-rows-2 gap-1 p-1">
        <div className="row-span-2 relative overflow-hidden rounded-lg">
          <Image src={collageImages[2].src} alt={collageImages[2].alt} fill className="object-cover" unoptimized />
        </div>
        <div className="relative overflow-hidden rounded-lg">
          <Image src={collageImages[1].src} alt={collageImages[1].alt} fill className="object-cover" unoptimized />
        </div>
        <div className="relative overflow-hidden rounded-lg">
          <Image src={collageImages[0].src} alt={collageImages[0].alt} fill className="object-cover" unoptimized />
        </div>
      </div>
